...
export const PROMPT_PREAMBLE = `You are an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and efficiently, adhering strictly to the following instructions and utilizing your available tools.`;

export const PROMPT_CORE_MANDATES = `
# Core Mandates
...
export const PROMPT_PRIMARY_WORKFLOWS_PREFIX = `
# Primary Workflows
...
export const PROMPT_PRIMARY_WORKFLOWS_PREFIX_CI = `
# Primary Workflows
...
export const PROMPT_PRIMARY_WORKFLOWS_PREFIX_CI_TODO = `
# Primary Workflows
...
export const PROMPT_PRIMARY_WORKFLOWS_TODO = `
# Primary Workflows
...
export const PROMPT_PRIMARY_WORKFLOWS_SUFFIX = `3. **Implement:** Use the available tools (e.g., '${EDIT_TOOL_NAME}', '${WRITE_FILE_TOOL_NAME}' '${SHELL_TOOL_NAME}' ...) to act on the plan, strictly adhering to the project's established conventions (detailed under 'Core 
Mandates').
...
export const PROMPT_TONE_AND_STYLE = `
...
export const PROMPT_SECURITY_AND_SAFETY = `
...
export const PROMPT_TOOL_USAGE_PREFIX = `
## Tool Usage
...
export const PROMPT_SHELL_EFFICIENCY = `
...
export const PROMPT_FINAL_REMINDER = `
# Final Reminder
...
export function getCoreSystemPrompt(
  ...
  if (systemMdEnabled) {
    ...
    const promptConfig = {
      ...
      coreMandates: PROMPT_CORE_MANDATES,
      primaryWorkflows_prefix: PROMPT_PRIMARY_WORKFLOWS_PREFIX,
      primaryWorkflows_prefix_ci: PROMPT_PRIMARY_WORKFLOWS_PREFIX_CI,
      primaryWorkflows_prefix_ci_todo: PROMPT_PRIMARY_WORKFLOWS_PREFIX_CI_TODO,
      primaryWorkflows_todo: PROMPT_PRIMARY_WORKFLOWS_TODO,
      primaryWorkflows_suffix: PROMPT_PRIMARY_WORKFLOWS_SUFFIX,
      operationalGuidelines: `
# Operational Guidelines
${(function () {
  if (config.getEnableShellOutputEfficiency()) {
    return PROMPT_SHELL_EFFICIENCY;
  }
  return '';
})()}
...
${(function () {
  if (!config.isInteractiveShellEnabled()) {
    return PROMPT_TOOL_USAGE_NON_INTERACTIVE;
  } else {
    return PROMPT_TOOL_USAGE_INTERACTIVE;
  }
})()}
...
`;
  ...
  return '';
      ...
      finalReminder: PROMPT_FINAL_REMINDER,
    };
